...
| Latest automated verification | `pnpm check` and `pnpm test` after the data-quality moderation UX slice | TypeScript passed; 13 Vitest files and 78 tests passed. |
