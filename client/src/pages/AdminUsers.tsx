...
import { AlertCircle, Loader2, Search, ShieldCheck, Users } from "lucide-react";
...
export default function AdminUsers() {
  ...
  if (!isAdmin) return <div className="min-h-screen bg-slate-50 py-12"><div className="container max-w-2xl"><Card className="p-8 text-center shadow-sm"><AlertCircle className="mx-auto mb-4 h-12 w-12 text-red-500" /><h1 className="text-2xl font-bold text-slate-950">Administrator access required</h1><p className="mt-2 text-slate-600">Only administrators can manage roles and user access.</p><ModerationBackLink className="mt-6" /></Card></div></div>;
