...
export default function CaptureResources() {
  ...
  return <div className="ns-noise min-h-[calc(100vh-4rem)] py-10 sm:py-14">
    <div className="container max-w-5xl">
      ...
      {!isAuthenticated ? <Card className="ns-surface mt-6 border-slate-200 p-6 text-center"><p className="text-slate-600">{t("signInToContribute")}</p><Button className="mt-4 bg-slate-950 text-white hover:bg-slate-800" onClick={() => startLogin()}>{t("signIn")}</Button></Card> : <div className="mt-6 grid gap-6 lg:grid-cols-[1.28fr_.72fr]">
